                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('SyaratDokumenUpdate',$SyaratDokumen->id)}}" method="POST">
                                    @csrf
                                    ...
                                    <option disabled {{ old('layanan_id', $SyaratDokumen->layanan_id) ? '' : 'selected' }}>-- Pilih Nama Layanan --</option>
                                    @foreach ($layanan as $ln)
                                    <option value="{{$ln->id}}" {{ old('layanan_id', $SyaratDokumen->layanan_id) == $ln->id ? 'selected' : '' }}>
                                    {{ $ln->service_name }}
                                    </option>
                                    @endforeach
                                            </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        name="require_document" id="require_document" value="{{$SyaratDokumen->require_document}}">
