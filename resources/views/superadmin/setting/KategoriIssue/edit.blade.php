                   ...
                   <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('KategoriIssueUpdate',$KategoriIssue->id)}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                    <div class="mb-3">
                                        <label for="category_name">Nama Layanan</label>
                                        <input type="text" class="form-control" placeholder="Masukkan Nama Layanan" 
                                        name="category_name" id="category_name" value="{{$KategoriIssue->category_name}}">
                                        @error('category_name')
